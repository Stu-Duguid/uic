...
// tealeaf config for minimal add to cart scenario
/**
...
(function () {
	...
	var config = {
		core: {
			...
			// },
			screenviewAutoDetect: false, // default true
		...
		services: {
			queue: {
				...
				queues: [{
					...
					maxEvents: 5,
					timerInterval: 1000, // default 0
					maxSize: 50000, // default 0
					checkEndpoint: false,
		...
		modules: {
			...
			replay: {
				...
				mousemove: {enabled: false, sampleRate: 200, ignoreRadius: 3} // default {}
			},
