                ...
                if (domCaptureService) {
                    ...
                    if (domCaptureData) {
                        ...
                        if (config.qffd !== false && !fullDOMFlushed && msg.domCapture.fullDOM) {
                            ...
                            // queueService.flush();
                            setTimeout(queueService.flush(), 0);
                            fullDOMFlushed = true;
                        }
                    }
                }
...
TLT.addService("domCapture", function (core) {
    ...
    var configService = core.getService("config"),
        ...
        lazyload = false,
        utils = core.utils,
        originalDOMAdoptedStyleSheetsDescriptor,
        originalShadowAdoptedStyleSheetsDescriptor,
        originalDOMStyleSheetsDescriptor,
        updateOwners = {},
        stylesCache = {};
    ...
    function initDOMCaptureService(config) {
        ...
        if (isCaptureDynamicStylesEnabled) {
            ...
            * Document.prototype.
            */
            originalDOMAdoptedStyleSheetsDescriptor = Object.getOwnPropertyDescriptor(Document.prototype, 'adoptedStyleSheets');
            originalDOMStyleSheetsDescriptor = Object.getOwnPropertyDescriptor(Document.prototype, 'styleSheets');
            ...
            * has been detected.
            ...
            CSSStyleSheet.prototype.replaceSyncOriginal = CSSStyleSheet.prototype.replaceSync;
            CSSStyleSheet.prototype.replaceOriginal = CSSStyleSheet.prototype.replace;
            CSSStyleSheet.prototype.replaceSync = replaceSyncProxy;
            CSSStyleSheet.prototype.replace = replaceProxy;

            CSSStyleSheet.prototype.publishOwnership = publishOwnership;
            CSSStyleSheet.prototype.removeOwnership = removeOwnership;

            CSSStyleSheet.prototype.updateOwner = updateOwner;
    ...
    function destroyDOMCaptureService() {
        ...
        if (originalDOMAdoptedStyleSheetsDescriptor) {
            Object.defineProperty(Document.prototype, 'adoptedStyleSheets', originalDOMAdoptedStyleSheetsDescriptor);
        }
        if (originalDOMStyleSheetsDescriptor) {
            Object.defineProperty(Document.prototype, 'styleSheets', originalDOMStyleSheetsDescriptor);
        }
    ...
    getDOMCapture = function (doc, root, rootXpath, options) {
        ...
        if (captureDynamicStyles && document.adoptedStyleSheets && (root instanceof Document || root instanceof ShadowRoot)) {
            var sheets;
            if (!root.domId) {
            ...
            if (updateOwners[root.domId]) {
                ...
                if (sheets && sheets.length > 0) {
                    ...
                    for (i = 0; i < sheets.length; i += 1) {
                        ...
                        if ((!captureHREFStyles && sheet.href) || sheet.ownerNode && sheet.ownerNode.textContent) continue;
                    ...
                    if (ruleTextArr.length > 0) {
                        style = '<style>' + ruleTextArr.join(" ") + '</style>';
